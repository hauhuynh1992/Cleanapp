...
public class InspectionPresenter
        implements InspectionContact.InspectionPresenter {
    InspectionActivity mView;
    private API mAPIService;

    public InspectionPresenter(InspectionActivity activity) {
        this.mView = (InspectionActivity) activity;
